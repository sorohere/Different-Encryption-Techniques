      ...
      <div className="space-y-8">
        <div className="bg-white/80 p-6 rounded-xl border border-violet-200">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              <p className="text-sm text-violet-600 mb-2">Key 1:</p>
              <p className="font-mono bg-white/90 p-2 rounded border border-violet-200">{key1}</p>
            </div>
            <div>
              <p className="text-sm text-violet-600 mb-2">Key 2:</p>
              <p className="font-mono bg-white/90 p-2 rounded border border-violet-200">{key2}</p>
            </div>
          </div>
        </div>
