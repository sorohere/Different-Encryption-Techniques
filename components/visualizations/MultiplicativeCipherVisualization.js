...
const MultiplicativeCipherVisualization = () => {
  ...
  const steps = plaintext.split('').map((char, index) => {
    ...
    return { original: char, multiplied: '', shifted: char, calculation: 'Non-alphabetic character' };
  });
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white/80 p-6 rounded-xl border border-violet-200">
          ...
          <div className="flex flex-col items-center space-y-6 mb-6">
            ...
            <div className="w-full">
              <p className="text-sm text-violet-600 mb-2 text-center">Multiplication Result</p>
              <div className="flex flex-wrap gap-2 justify-center">
                {steps.map((step, index) => (
                  <motion.div
                    key={index}
            ...
            <div className="w-full">
              <p className="text-sm text-violet-600 mb-2 text-center">Modulo Result (Encrypted Text)</p>
              <div className="flex flex-wrap gap-2 justify-center">
                {steps.map((step, index) => (
                  <motion.div
                    key={index}
